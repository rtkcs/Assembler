...
out_string:
    ...
    push  dword [ebp+8]     ; push to the registry the output string, function input parameter
    push  dword string_fmt  ; push to the registry the format string 
    call  printf            ; call the C function printf("%s", output_string) 
    pop   ecx
    pop   ecx
